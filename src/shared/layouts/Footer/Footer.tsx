    ...
    <footer className="text-[#404756] dark:text-[#99A1B3]">
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-x-12 gap-y-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col">
          ...
          <FooterLink href="/learn/faza-0/modul-0-1/bit-ve-byte">
            FAZA 0 — Kompüter
          </FooterLink>
        ...
        <div className="md:col-start-2 xl:col-start-4 flex flex-col">
          ...
          <FooterLink href="https://github.com/hesenv07/engineering-curriculum">
            GitHub Reposu
          </FooterLink>
          <FooterLink href="https://github.com/hesenv07/engineering-curriculum/issues">
            Xəta bildiriş
          </FooterLink>
          <FooterLink href="https://github.com/hesenv07/engineering-curriculum/blob/main/README.md">
            Töhfə ver
          </FooterLink>
          <FooterLink href="https://www.linkedin.com/in/arifhesenov/">
            LinkedIn
          </FooterLink>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <FooterLink href="https://github.com/hesenv07/engineering-curriculum/blob/main/LICENSE">
            MIT Lisenziyası
          </FooterLink>
          <FooterLink href="https://github.com/hesenv07/engineering-curriculum/blob/main/README.md">
            README
          ...
          <div className="flex flex-row items-center mt-8 gap-x-2">
            ...
            <a
              aria-label="LinkedIn"
              href="https://www.linkedin.com/in/huseynalizde33/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-[#087EA4] dark:text-[#99A1B3] transition-colors"
            >
